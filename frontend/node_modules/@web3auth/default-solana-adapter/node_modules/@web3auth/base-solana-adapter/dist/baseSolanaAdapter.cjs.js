...
;// ./src/baseSolanaAdapter.ts



class BaseSolanaAdapter extends base_namespaceObject.BaseAdapter {
  async init(_) {
    if (!this.chainConfig) this.chainConfig = (0,base_namespaceObject.getChainConfig)(base_namespaceObject.CHAIN_NAMESPACES.SOLANA, 1, this.clientId);
  }
  async authenticateUser() {
    ...
    if (accounts && accounts.length > 0) {
      ...
      const idToken = await (0,base_controllers_namespaceObject.verifySignedChallenge)(chainNamespace, external_bs58_default().encode(signedMessage), challenge, this.name, this.sessionTime, this.clientId, this.web3AuthNetwork);
