...
class BaseSolanaAdapter extends base.BaseAdapter {
  async init(_) {
    if (!this.chainConfig) this.chainConfig = base.getChainConfig(base.CHAIN_NAMESPACES.SOLANA, 1, this.clientId);
  }
  async authenticateUser() {
    ...
    if (accounts && accounts.length > 0) {
      ...
      const idToken = await baseControllers.verifySignedChallenge(chainNamespace, bs58.encode(signedMessage), challenge, this.name, this.sessionTime, this.clientId, this.web3AuthNetwork);
...
exports.BaseSolanaAdapter = BaseSolanaAdapter;
