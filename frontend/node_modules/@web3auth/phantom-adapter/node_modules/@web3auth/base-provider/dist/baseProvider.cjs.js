...
class BaseProvider extends base_controllers_namespaceObject.BaseController {
  ...
  addChain(chainConfig) {
    if (!chainConfig.chainId) throw openlogin_jrpc_namespaceObject.rpcErrors.invalidParams("chainId is required");
    if (!chainConfig.rpcTarget) throw openlogin_jrpc_namespaceObject.rpcErrors.invalidParams("chainId is required");
    this.configure({
  ...
  getChainConfig(chainId) {
    ...
    if (!chainConfig) throw openlogin_jrpc_namespaceObject.rpcErrors.invalidRequest(`Chain ${chainId} is not supported, please add chainConfig for it`);
    return chainConfig;
  }
