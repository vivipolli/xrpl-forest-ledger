...
const detectProvider = async (options = {
  interval: 1000,
  count: 3
}) => {
  var _window$solana;
...
class PhantomAdapter extends base_solana_adapter_namespaceObject.BaseSolanaAdapter {
  ...
  get provider() {
    if (this.status !== base_namespaceObject.ADAPTER_STATUS.NOT_READY && this.phantomProvider) {
      ...
      if (!this._wallet.isConnected) {
        ...
        try {
          await new Promise((resolve, reject) => {
            ...
            this._wallet._handleDisconnect = (...args) => {
          ...
          throw base_namespaceObject.WalletLoginError.connectionError(error === null || error === void 0 ? void 0 : error.message, error);
        } finally {
