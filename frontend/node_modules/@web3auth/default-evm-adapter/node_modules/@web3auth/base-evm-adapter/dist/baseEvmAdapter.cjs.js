...
;// ./src/baseEvmAdapter.ts


class BaseEvmAdapter extends base_namespaceObject.BaseAdapter {
  async init(_) {
    if (!this.chainConfig) this.chainConfig = (0,base_namespaceObject.getChainConfig)(base_namespaceObject.CHAIN_NAMESPACES.EIP155, 1, this.clientId);
  }
