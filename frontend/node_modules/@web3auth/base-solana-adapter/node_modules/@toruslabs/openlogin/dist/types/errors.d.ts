...
export declare class LoginError extends OpenloginError {
    ...
    static popupBlocked(extraMessage?: string): OpenloginError;
    static mfaAlreadyEnabled(extraMessage?: string): OpenloginError;
    static mfaNotEnabled(extraMessage?: string): OpenloginError;
}
