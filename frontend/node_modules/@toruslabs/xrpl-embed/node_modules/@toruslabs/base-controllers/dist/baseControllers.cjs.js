...
class BaseTransactionStateManager extends _BaseController__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z {
  ...
  getUnapprovedTxList() {
    ...
    return (0,lodash__WEBPACK_IMPORTED_MODULE_1__.pickBy)(this.state.transactions, transaction => transaction.status === _ITransactionController__WEBPACK_IMPORTED_MODULE_4__/* .TransactionStatus */ .LN.unapproved && (0,_utils__WEBPACK_IMPORTED_MODULE_3__/* .transactionMatchesNetwork */ .lw)(transaction, chainId));
  }
  getTransaction(txId) {
    const {
      transactions
  ...
  setTxStatusRejected(txId) {
    this._setTransactionStatus(txId, _ITransactionController__WEBPACK_IMPORTED_MODULE_4__/* .TransactionStatus */ .LN.rejected);
  ...
  setTxStatusUnapproved(txId) {
    this._setTransactionStatus(txId, _ITransactionController__WEBPACK_IMPORTED_MODULE_4__/* .TransactionStatus */ .LN.unapproved);
  }
  setTxStatusApproved(txId) {
    this._setTransactionStatus(txId, _ITransactionController__WEBPACK_IMPORTED_MODULE_4__/* .TransactionStatus */ .LN.approved);
  }
  setTxStatusSigned(txId, isFinalStep) {
    this._setTransactionStatus(txId, _ITransactionController__WEBPACK_IMPORTED_MODULE_4__/* .TransactionStatus */ .LN.signed, isFinalStep);
  }
  setTxStatusSubmitted(txId) {
    this._setTransactionStatus(txId, _ITransactionController__WEBPACK_IMPORTED_MODULE_4__/* .TransactionStatus */ .LN.submitted);
  }
  setTxStatusDropped(txId) {
    this._setTransactionStatus(txId, _ITransactionController__WEBPACK_IMPORTED_MODULE_4__/* .TransactionStatus */ .LN.dropped);
  }
  setTxStatusExpired(txId) {
    this._setTransactionStatus(txId, _ITransactionController__WEBPACK_IMPORTED_MODULE_4__/* .TransactionStatus */ .LN.expired);
  }
  setTxStatusConfirmed(txId) {
    this._setTransactionStatus(txId, _ITransactionController__WEBPACK_IMPORTED_MODULE_4__/* .TransactionStatus */ .LN.confirmed);
  }
  setTxStatusFailed(txId, error_) {
    ...
    this._setTransactionStatus(txId, _ITransactionController__WEBPACK_IMPORTED_MODULE_4__/* .TransactionStatus */ .LN.failed);
  }
   ...
   */
  isFinalState(status) {
    return status === _ITransactionController__WEBPACK_IMPORTED_MODULE_4__/* .TransactionStatus */ .LN.rejected || status === _ITransactionController__WEBPACK_IMPORTED_MODULE_4__/* .TransactionStatus */ .LN.submitted || status === _ITransactionController__WEBPACK_IMPORTED_MODULE_4__/* .TransactionStatus */ .LN.confirmed || status === _ITransactionController__WEBPACK_IMPORTED_MODULE_4__/* .TransactionStatus */ .LN.failed || status === _ITransactionController__WEBPACK_IMPORTED_MODULE_4__/* .TransactionStatus */ .LN.cancelled || status === _ITransactionController__WEBPACK_IMPORTED_MODULE_4__/* .TransactionStatus */ .LN.expired;
  }
  ...
  clearUnapprovedTxs() {
    this.update({
      transactions: (0,lodash__WEBPACK_IMPORTED_MODULE_1__.omitBy)(this.state.transactions, transaction => transaction.status === _ITransactionController__WEBPACK_IMPORTED_MODULE_4__/* .TransactionStatus */ .LN.unapproved)
    });
  }
  ...
  _setTransactionStatus(txId, status, isFinalStep) {
    ...
    this.updateTransaction(txMeta);
    this.emit(_ITransactionController__WEBPACK_IMPORTED_MODULE_4__/* .TX_EVENTS */ .RM.TX_STATUS_UPDATE, {
      txId,
      status
    });
