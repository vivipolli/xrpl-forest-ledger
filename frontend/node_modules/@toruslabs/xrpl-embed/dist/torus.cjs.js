...
/* harmony default export */ const loglevel = (external_loglevel_default().getLogger("xrpl-embed"));
...
class BaseProvider extends openlogin_jrpc_namespaceObject.SafeEventEmitter {
  constructor(connectionStream, _ref) {
    ...
    if (!(0,external_is_stream_namespaceObject.isDuplexStream)(connectionStream)) {
  ...
  _handleAccountsChanged(accounts) {
    ...
    if (!external_fast_deep_equal_default()(this._state.accounts, finalAccounts)) {
      ...
      if (isEthAccounts && Array.isArray(this._state.accounts) && this._state.accounts.length > 0 && !isInternal) {
        loglevel.error('Torus: "xrpl_getAccounts" unexpectedly updated accounts. Please report this bug.', finalAccounts);
      }
