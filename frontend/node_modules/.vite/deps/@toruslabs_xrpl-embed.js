import {
  ...
  require_lodash2,
  require_regenerator
} from "./chunk-2VJNZC3S.js";
import "./chunk-FUN6XYTU.js";
import {
  _defineProperty,
  bowser_default,
  keccak256,
...
var require_primordials = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/ours/primordials.js"(exports, module) {
    "use strict";
...
var require_inspect = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/ours/util/inspect.js"(exports, module) {
    "use strict";
    module.exports = {
      format(format, ...args) {
...
var require_errors = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/ours/errors.js"(exports, module) {
    "use strict";
...
var require_util = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/ours/util.js"(exports, module) {
    "use strict";
...
var require_validators = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/internal/validators.js"(exports, module) {
    "use strict";
    var {
      ArrayIsArray,
...
var require_utils = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/internal/streams/utils.js"(exports, module) {
    "use strict";
...
var require_legacy = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/internal/streams/legacy.js"(exports, module) {
    "use strict";
...
var require_add_abort_signal = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/internal/streams/add-abort-signal.js"(exports, module) {
    "use strict";
...
var require_from = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/internal/streams/from.js"(exports, module) {
    "use strict";
    var process = require_browser2();
...
var require_readable = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/internal/streams/readable.js"(exports, module) {
    "use strict";
    var process = require_browser2();
    var {
...
var require_writable = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/internal/streams/writable.js"(exports, module) {
    "use strict";
    var process = require_browser2();
    var {
      ArrayPrototypeSlice,
...
var require_duplexify = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/internal/streams/duplexify.js"(exports, module) {
    var process = require_browser2();
    var bufferModule = require_buffer();
    var {
      isReadable,
...
var require_duplex = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/internal/streams/duplex.js"(exports, module) {
    "use strict";
    var {
      ObjectDefineProperties,
...
var require_transform = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/internal/streams/transform.js"(exports, module) {
    "use strict";
...
var require_passthrough = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/internal/streams/passthrough.js"(exports, module) {
    "use strict";
...
var require_compose = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/internal/streams/compose.js"(exports, module) {
    "use strict";
...
var require_operators = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/internal/streams/operators.js"(exports, module) {
    "use strict";
    var AbortController = globalThis.AbortController || require_browser().AbortController;
    var {
...
var require_promises = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/stream/promises.js"(exports, module) {
    "use strict";
...
var require_stream = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/stream.js"(exports, module) {
    "use strict";
    var { Buffer: Buffer2 } = require_buffer();
...
var require_browser3 = __commonJS({
  "node_modules/@toruslabs/openlogin-jrpc/node_modules/readable-stream/lib/ours/browser.js"(exports, module) {
    "use strict";
...
var import_rpc_errors = __toESM(require_dist());
  ...
  static _runMiddleware(req, res, middleware, returnHandlers) {
    return new Promise((resolve) => {
      const end = (err) => {
        ...
        if (error) {
          res.error = (0, import_rpc_errors.serializeError)(error);
        }
        resolve([error, true]);
      };
...
// node_modules/@toruslabs/xrpl-embed/node_modules/@toruslabs/base-controllers/dist/baseControllers.esm.js
var import_util9 = __toESM(require_dist3());
var import_rpc_errors2 = __toESM(require_dist());
...
// node_modules/@toruslabs/broadcast-channel/node_modules/@toruslabs/http-helpers/dist/httpHelpers.esm.js
...
// node_modules/@toruslabs/broadcast-channel/node_modules/@toruslabs/metadata-helpers/dist/metadataHelpers.esm.js
      ...
      return import_regenerator.default.wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            _context.t1 = encData;
            _context.next = 9;
            return sign(channelEncPrivKey, keccak2562(Buffer.from(encData, "utf8")));
          case 9:
...
function getSocketInstance(serverUrl) {
  ...
  var SOCKET_CONN = lookup(serverUrl, {
...
var log3 = import_loglevel3.default.getLogger("http-helpers");
log3.setLevel(import_loglevel3.levels.INFO);
...
function createLoggerMiddleware(options) {
  return function loggerMiddleware(request, response, next) {
    next((callback) => {
      if (response.error) {
        import_loglevel4.default.warn("Error in RPC response:\n", response);
      }
      if (request.isTorusInternal) return;
      import_loglevel4.default.info(`RPC (${options.origin}):`, request, "->", response);
      callback();
    });
  };
}
...
// node_modules/@toruslabs/xrpl-embed/dist/torus.esm.js
var import_eth_rpc_errors = __toESM(require_dist2());
...
var log5 = import_loglevel5.default.getLogger("xrpl-embed");
function createErrorMiddleware() {
  return (req, res, next) => {
    ...
    next((done) => {
      ...
      log5.error(`Torus - RPC Error: ${error.message}`, error);
      return done();
    });
  };
}
...
var TorusCommunicationProvider = class _TorusCommunicationProvider extends BaseProvider {
  ...
  async _initializeState(params) {
    try {
      ...
      log5.error("Torus: Failed to get initial state. Please report this bug.", error);
    } finally {
      log5.info("initialized communication state");
  ...
  _handleConnect(currentLoginProvider, isLoggedIn) {
    if (!this._state.isConnected) {
      ...
      log5.debug(messages.info.connected(currentLoginProvider));
    }
  }
  /**
...
var TorusInPageProvider = class _TorusInPageProvider extends BaseProvider {
  ...
  async _initializeState() {
    try {
      ...
      log5.info("initialized provider state");
      this._state.initialized = true;
      this.emit("_initialized");
    }
  }
  ...
  _handleConnect(chainId) {
    if (!this._state.isConnected) {
      ...
      log5.debug(messages.info.connected(chainId));
    }
  }
  /**
   * When the provider becomes disconnected, updates internal state and emits
  ...
  _handleAccountsChanged(accounts) {
    ...
    if (!Array.isArray(finalAccounts)) {
      log5.error("Torus: Received non-array accounts parameter. Please report this bug.", finalAccounts);
      finalAccounts = [];
    }
    for (const account of accounts) {
      if (typeof account !== "string") {
        log5.error("Torus: Received non-string account. Please report this bug.", accounts);
        finalAccounts = [];
        break;
      }
    }
    if (!(0, import_fast_deep_equal.default)(this._state.accounts, finalAccounts)) {
      if (isEthAccounts && Array.isArray(this._state.accounts) && this._state.accounts.length > 0 && !isInternal) {
        log5.error('Torus: "xrpl_getAccounts" unexpectedly updated accounts. Please report this bug.', finalAccounts);
      }
  ...
  _handleChainChanged() {
    ...
    if (!chainId) {
      log5.error("Torus: Received invalid network parameters. Please report this bug.", {
        chainId
      });
      return;
    }
  ...
  _handleUnlockStateChanged() {
    ...
    if (typeof isUnlocked !== "boolean") {
      log5.error("Torus: Received invalid isUnlocked parameter. Please report this bug.", {
        isUnlocked
      });
      return;
    }
...
var PROVIDER_UNSAFE_METHODS = ["xrpl_signTransaction", "xrpl_submitTransaction", "xrpl_signMessage"];
...
var Torus = class {
  ...
  async init() {
    ...
    log5.info(torusUrl, "url loaded");
    this.torusUrl = torusUrl;
    log5.setDefaultLevel(logLevel3);
    if (enableLogging) log5.enableAll();
    else log5.disableAll();
  ...
  async signMessage(params) {
    if (!this.isInitialized) throw new Error("Torus is not initialized");
    const signMessageRes = await this.provider.request({
  ...
  async _setupWeb3(providerParams) {
    ...
    log5.debug("Torus - injected provider");
  }
...
//# sourceMappingURL=@toruslabs_xrpl-embed.js.map
